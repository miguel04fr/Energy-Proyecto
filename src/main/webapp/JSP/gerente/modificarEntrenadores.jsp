                            ...
                            <div class="card-body">
                                ...
                                <div class="btn-container">
                                    ...
                                    <form action="Delete" method="post" class="w-100">
                                        <input type="hidden" name="id" value="${usuario.id}">
                                        <button class="btn btn-danger" type="submit" name="eliminarEntrenador" value="eliminarEntrenador">
                                            <i class="fas fa-trash-alt"></i> Eliminar
                                        </button>
                                    </form>
                                    <form action="Update" method="post" class="w-100">
                                        <input type="hidden" name="id" value="${usuario.id}">
                                        <button class="btn btn-primary" type="submit" name="editarEntrenador" value="editarEntrenador">
                                            <i class="fas fa-edit"></i> Editar
                                        </button>
                                    </form>
                                </div>
