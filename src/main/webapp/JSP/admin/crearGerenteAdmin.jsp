                ...
                <form action="${pageContext.request.contextPath}/Create" method="post" class="admin-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="password-input">
                            <input type="password" id="clave" name="clave" minlength="8" maxlength="16" title="La contraseña debe tener al menos 8 caracteres, una letra y un número" required pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$">
                    ...
                    <div class="form-group">
                        ...
                        <div class="password-input">
                            <input type="password" id="confirmarClave" name="confirmarClave" minlength="8" maxlength="16" title="La contraseña debe tener al menos 8 caracteres, una letra y un número" required pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$">
                            <button type="button" class="toggle-password">
                                <i class="fas fa-eye"></i>
                            </button>
                        </div>
